...
mixin _$UserCredentials {
  ...
  bool get isSaveSession => throw _privateConstructorUsedError;
...
abstract class $UserCredentialsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, bool isSaveSession});
}
    ...
    return _then(_value.copyWith(
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      isSaveSession: null == isSaveSession
          ? _value.isSaveSession
          : isSaveSession // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$_UserCredentials implements _UserCredentials {
  const _$_UserCredentials({required this.name, this.isSaveSession = false});
  ...
  @override
  @JsonKey()
  final bool isSaveSession;

  @override
  String toString() {
    return 'UserCredentials(name: $name, isSaveSession: $isSaveSession)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isSaveSession, isSaveSession) ||
                other.isSaveSession == isSaveSession));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, isSaveSession);
...
abstract class _UserCredentials implements UserCredentials {
  const factory _UserCredentials(
      ...
      final bool isSaveSession}) = _$_UserCredentials;
